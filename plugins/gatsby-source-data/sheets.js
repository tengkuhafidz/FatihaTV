...
var Sheets = /** @class */ (function () {
    function Sheets(apiKey) {
        var _this = this;
        this.BASE_URL = "https://sheets.googleapis.com/v4/spreadsheets/";
        this.url = function (spreadsheetId, range) {
            return _this.BASE_URL + spreadsheetId + '/values/' + range + '?key=' + _this.API_KEY;
        };
        /*
          "values": [
          [
        ...
        */
        this.getOrganisationData = function () { return __awaiter(_this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1["default"].get(this.url('1l0YvEG8IpYFZ0KZLw6Y4jzbRrCWv5aLZjrFYyNulwPg', 'A:F'))];
                    case 1:
                        res = _a.sent();
