...
var API_KEY = process.env.GATSBY_YOUTUBE_API_KEY;
...
var Youtube = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].get(Youtube.url("channels", part, params))];
                    case 1:
                        res = _a.sent();
                        this.usedQuota += cost;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].get(Youtube.url("playlists", part, params))];
                    case 1:
                        res = _a.sent();
                        this.usedQuota += cost;
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, axios_1["default"].get(Youtube.url("playlists", part, __assign(__assign({}, params), { pageToken: res.data.nextPageToken })))];
                    case 3:
                        res = _a.sent();
                        this.usedQuota += cost;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].get(Youtube.url("playlistItems", part, params))];
                    case 1:
                        res = _a.sent();
                        this.usedQuota += cost;
                    ...
                    case 2:
                        if (!res.data.nextPageToken) return [3 /*break*/, 4];
                        return [4 /*yield*/, axios_1["default"].get(Youtube.url("playlistItems", part, __assign(__assign({}, params), { pageToken: res.data.nextPageToken })))];
                    case 3:
                        res = _a.sent();
                        this.usedQuota += cost;
    ...
    Youtube.url = function (service, part, params) {
