    ...
    return(
        <div className="fixed bottom-0 pb-8 w-full hidden md:block pointer-events-none">
            <div className="bg-gray-900 p-4 md:max-w-screen-sm rounded-lg mx-auto shadow-lg pointer-events-auto border border-gray-100" role="alert">
                ...
                <OutboundLink className="bg-white hover:bg-gray-200 text-gray-800 py-1 px-4 rounded float-right -mt-1 cursor-pointer" href="https://www.giving.sg/pergas/gracious_package" target="_blank">
                    Learn More
                </OutboundLink>
            </div>
        </div>
