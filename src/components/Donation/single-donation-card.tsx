...
const SingleDonationCard: React.FC<Props> = ({ donationData }) => {
    const { organisation, paynow } = donationData

    return (  
        <div className="max-w-sm rounded overflow-hidden shadow-lg bg-white hover:scale-110 hover:shadow-xl transform hover:scale-110">
