    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-sm mx-auto">
            <ul className="flex">
                ...
                <li className="flex-1">
                    <a className="text-center block border border-teal-500 rounded hover:border-gray-200 text-teal-500 hover:bg-gray-200 py-2 px-4 cursor-pointer" onClick={() => navigate('/live')}>Upcoming Lives</a>
                </li>
            </ul>
        </div>
        <Playlists />
